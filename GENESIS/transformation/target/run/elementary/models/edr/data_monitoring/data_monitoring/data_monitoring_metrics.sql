-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into GENESIS_UAT.TEC_MONITORING.data_monitoring_metrics as DBT_INTERNAL_DEST
        using GENESIS_UAT.TEC_MONITORING.data_monitoring_metrics__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
