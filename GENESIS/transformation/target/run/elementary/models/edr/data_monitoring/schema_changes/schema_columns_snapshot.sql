-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into GENESIS_UAT.TEC_MONITORING.schema_columns_snapshot as DBT_INTERNAL_DEST
        using GENESIS_UAT.TEC_MONITORING.schema_columns_snapshot__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
