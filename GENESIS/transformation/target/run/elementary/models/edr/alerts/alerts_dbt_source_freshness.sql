  ...
  create or replace   view GENESIS_UAT.TEC_MONITORING.alerts_dbt_source_freshness
  
   as (
    

with results as (
  select * from GENESIS_UAT.TEC_MONITORING.dbt_source_freshness_results
),

sources as (
  select * from GENESIS_UAT.TEC_MONITORING.dbt_sources
)
