  ...
  create or replace   view GENESIS_UAT.TEC_MONITORING.alerts_dbt_models
...
with error_models as (
    ...
    select  model_execution_id,
            ...
            owner,
            alias 
    from GENESIS_UAT.TEC_MONITORING.model_run_results
    ...
    select  model_execution_id,
            ...
            owner,
            alias  
  from GENESIS_UAT.TEC_MONITORING.snapshot_run_results
)
