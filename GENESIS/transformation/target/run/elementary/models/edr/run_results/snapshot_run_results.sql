  ...
  create or replace   view GENESIS_UAT.TEC_MONITORING.snapshot_run_results
  
   as (
    

with dbt_run_results as (
    select * from GENESIS_UAT.TEC_MONITORING.dbt_run_results
),

dbt_snapshots as (
    select * from GENESIS_UAT.TEC_MONITORING.dbt_snapshots
)
