-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into GENESIS_UAT.TEC_MONITORING.elementary_test_results as DBT_INTERNAL_DEST
        using GENESIS_UAT.TEC_MONITORING.elementary_test_results__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
