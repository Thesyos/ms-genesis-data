-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into GENESIS_UAT.TEC_MONITORING.test_result_rows as DBT_INTERNAL_DEST
        using GENESIS_UAT.TEC_MONITORING.test_result_rows__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
