-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into GENESIS_UAT.TEC_MONITORING.dbt_exposures as DBT_INTERNAL_DEST
        using GENESIS_UAT.TEC_MONITORING.dbt_exposures__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
